export const zhTranslations = {
  app: { name: 'FingerGuide', tagline: '打字练习大师', subtitle: '通过实时手指引导和本地进度跟踪掌握打字技能' },
  nav: { practice: '练习', stats: '统计', achievements: '成就', settings: '设置' },
  practice: { wpm: '速度', accuracy: '准确率', time: '时间', completed: '练习完成！', continuePrompt: '按空格键或点击按钮继续', totalTime: '总时长', sessions: '练习次数', speed: '速度' },
  fingers: { left: '左手', right: '右手', pinky: '小指', ring: '无名指', middle: '中指', index: '食指', thumb: '大拇指' },
  completion: { title: '练习完成！', saved: '您的进步已成功保存。', continue: '按空格键或点击按钮继续', continueButton: '继续练习' },
  mode: { normal: '普通模式', timeChallenge: '倒计时模式', custom: '自定义文本', selectDuration: '选择时长', start: '开始', cancel: '取消', customTitle: '练习自定义文本', customPlaceholder: '在此粘贴或输入文本...', customMinLength: '文本至少需要10个字符', customStart: '开始练习' },
  user: { createAccount: '创建账户', selectAccount: '选择账户', localAccount: '本地账户', switchAccount: '切换账户', enterName: '输入您的名字', createNewAccount: '创建新账户' },
  account: { localAccount: '本地账户' },
  footer: { title: 'FingerGuide 打字大师', focusOnAccuracy: '专注准确度', buildMuscleMemory: '建立肌肉记忆', dailyPractice: '每日练习' },
  ...
  heatmap: { title: '错误热力图', subtitle: '可视化您最常输错的按键', reset: '重置', resetConfirm: '确定要重置热力图数据吗？此操作无法撤销。', lessErrors: '错误较少', moreErrors: '错误较多', noData: '暂无数据。完成一些练习后会显示您的错误模式！' },
  progress: { title: '进度趋势', subtitle: '追踪您的打字速度和准确率变化', days7: '7天', days30: '30天', days90: '90天', wpmLegend: 'WPM (速度)', accuracyLegend: '准确率 %', noData: '暂无历史记录。练习几次后您的进度将显示在这里。' },
  settings: { title: '设置', language: '语言', theme: '主题', pet: '宠物', selectPet: '选择宠物', selectLanguage: '选择语言', chinese: '中文', english: 'English' },
  'theme.forest': '森林', 'theme.meadow': '草地', 'theme.desert': '沙漠', 'theme.savanna': '草原', 'theme.sky': '天空', 'theme.volcano': '火山',
  achievements: {
